...
**גרסה: 1.2.0** | עדכון אחרון: 2026-07-07

> **מקור האמת**: `topcrefit/claude-skills` — כל עדכון לכללים מתבצע שם קודם, עם העלאת גרסה בטבלת ה-changelog, ומשם מופץ לכל שאר הריפואים. עותקים בריפואים אחרים הם שכפול לקריאה בלבד.
...
| גרסה | תאריך | שינויים |
|------|--------|---------|
| 1.2.0 | 2026-07-07 | קביעת מקור אמת רשמי למסמך: `topcrefit/claude-skills` |
...
*Master System Architecture Spec — v1.2.0*
